...
There are millions of people in the world who have a disability and many have to rely on a screen reader when using their computers. For example, if someone is blind and wants to know what the pictures on the website mean or if someone is colorblind and needs to know the difference between the two buttons.

2. Talk about 3 different things you can do to ensure your website is accessible.

1.) Make sure the html is semantic.

2.) Add alt to the image tags.

3.) Make it responsive.

3. How would you explain the concept of a variable to someone new to programming?
   I would compare variable in math to a variable in javscript. It's a way to store information.

4. What is the purpose of using functions in code?

You use functions so that you can repeat sections of code. So that you don't have to keep copy and pasting. You want to be able to write the smallest amount of code possible.
